...
public class RoundCornerImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // 读取配置
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.RTCCallingRoundCornerImageView);
        mRadius = array.getDimensionPixelOffset(R.styleable.RTCCallingRoundCornerImageView_radius, mDefaultRadius);
        mLeftTopRadius = array.getDimensionPixelOffset(R.styleable.RTCCallingRoundCornerImageView_left_top_radius, mDefaultRadius);
        mRightTopRadius = array.getDimensionPixelOffset(R.styleable.RTCCallingRoundCornerImageView_right_top_radius, mDefaultRadius);
        mRightBottomRadius = array.getDimensionPixelOffset(R.styleable.RTCCallingRoundCornerImageView_right_bottom_radius, mDefaultRadius);
        mLeftBottomRadius = array.getDimensionPixelOffset(R.styleable.RTCCallingRoundCornerImageView_left_bottom_radius, mDefaultRadius);
