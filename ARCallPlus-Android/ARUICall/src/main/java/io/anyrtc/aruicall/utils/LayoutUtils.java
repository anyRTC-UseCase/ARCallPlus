...
public class LayoutUtils {
    ...
    public static ArrayList<RelativeLayout.LayoutParams> initFloatParamList(Context context, int layoutWidth, int layoutHeight) {
        ...
        final int midMargin = LayoutUtils.dip2px(context, 10);
        final int lrMargin = LayoutUtils.dip2px(context, 15);
        final int bottomMargin = LayoutUtils.dip2px(context, 50);
        final int subWidth = LayoutUtils.dip2px(context, 120);
        final int subHeight = LayoutUtils.dip2px(context, 180);
        for (int i = 2; i >= 0; i--) {
