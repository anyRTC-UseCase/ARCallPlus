...
extern const NSString * ARUICSToastPositionTop;
extern const NSString * ARUICSToastPositionCenter;
extern const NSString * ARUICSToastPositionBottom;

@class ARUICSToastStyle;
...
/**
 `ARUICSToastStyle` instances define the look and feel for toast views created via the
 `makeToast:` methods as well for toast views created directly with
 `toastViewForMessage:title:image:style:`.
 
 @warning `ARUICSToastStyle` offers relatively simple styling options for the default
 toast view. If you require a toast view with more complex UI, it probably makes more
 sense to create your own custom UIView subclass and present it with the `showToast:`
 methods.
 */
@interface ARUICSToastStyle : NSObject
...
/**
 Creates a new instance of `ARUICSToastStyle` with all the default values set.
 */
- (instancetype)initWithDefaultStyle NS_DESIGNATED_INITIALIZER;

/**
 @warning Only the designated initializer should be used to create
 an instance of `ARUICSToastStyle`.
 */
...
/**
 `ARUICSToastManager` provides general configuration options for all toast
 notifications. Backed by a singleton instance.
 */
@interface ARUICSToastManager : NSObject
...
/**
 ...
 with with a nil style. By default, this is set to `ARUICSToastStyle`'s default
 style.
...
/**
 ...
 `ARUICSToastStyle`'s default style.
...
/**
 ...
 Default is `ARUICSToastPositionBottom`.
...
/**
 Returns the default toast position. Default is `ARUICSToastPositionBottom`.
