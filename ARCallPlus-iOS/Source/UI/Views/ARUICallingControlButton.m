...
@interface ARUICallingControlButton()

@property (nonatomic, copy) ARUICallingButtonActionBlcok buttonActionBlock;
...
@implementation ARUICallingControlButton
...
+ (instancetype)createViewWithFrame:(CGRect)frame titleText:(NSString *)titleText  buttonAction:(ARUICallingButtonActionBlcok)buttonAction imageSize:(CGSize)imageSize {
    ARUICallingControlButton *controlView = [[ARUICallingControlButton alloc] initWithFrame:frame imageSize:imageSize];
