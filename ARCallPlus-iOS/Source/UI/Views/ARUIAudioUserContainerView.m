...
@interface ARUIAudioUserContainerView ()
...
@implementation ARUIAudioUserContainerView
...
- (void)configUserInfoViewWith:(CallUserModel *)userModel showWaitingText:(NSString *)text {
    [self.userHeadImageView sd_setImageWithURL:[NSURL URLWithString:userModel.avatar] placeholderImage:[ARUICommonUtil getBundleImageWithName:@"userIcon"]];
